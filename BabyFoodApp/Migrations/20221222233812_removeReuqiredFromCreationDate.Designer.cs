...
namespace BabyFoodApp.Migrations
{
    ...
    [Migration("20221222233812_removeReuqiredFromCreationDate")]
    partial class removeReuqiredFromCreationDate
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BabyFoodApp.Data.IdentityModels.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("BabyFoodApp.Data.IdentityModels.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
